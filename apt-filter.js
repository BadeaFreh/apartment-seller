...
const findRelevantApts = function (address, minPrice, maxPrice, minRooms, maxRooms, immediate, isParking) {
    ...
    isParking = !isParking[0].checked
    relevantApts = immediate ? relevantApts : relevantApts.filter(a => (a.immediate))
    return isParking ? relevantApts : relevantApts.filter(a => (a.parking))
}
